import{a as C,d as U,F as A,N as D,x as u,X as K,O as W,R as S,D as j,J as V,M,W as F,r as Q,e as q}from"./index-8gFOtagK.js";import{r as a,n as g,c as E,U as m}from"./if-defined-D81X5Jr1.js";import"./index-CPmtn8yi.js";import{M as R}from"./index-Cc-PLWeQ.js";import"./index-x8JnE1yd.js";import{S as n}from"./index-Ch1m3sM9.js";import"./index-BWHt43CD.js";import"./index-C0gvoikH.js";import"./index-BOdkgbbj.js";import"./index-CaWW1NaR.js";import"./index-B3wf2gw8.js";const G={numericInputKeyDown(c,t,e){const o=["Backspace","Meta","Ctrl","a","A","c","C","x","X","v","V","ArrowLeft","ArrowRight","Tab"],s=c.metaKey||c.ctrlKey,i=c.key,r=i.toLocaleLowerCase(),l=r==="a",x=r==="c",v=r==="v",N=r==="x",_=i===",",L=i===".",B=i>="0"&&i<="9";!s&&(l||x||v||N)&&c.preventDefault(),t==="0"&&!_&&!L&&i==="0"&&c.preventDefault(),t==="0"&&B&&(e(i),c.preventDefault()),(_||L)&&(t||(e("0."),c.preventDefault()),(t!=null&&t.includes(".")||t!=null&&t.includes(","))&&c.preventDefault()),!B&&!o.includes(i)&&!L&&!_&&c.preventDefault()}},H=C`
  :host {
    width: 100%;
  }
...
`;var z=function(c,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(s<3?r(i):s>3?r(t,e,i):r(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};let O=class extends U{constructor(){super(...arguments),this.target="sourceToken"}render(){return u`
    ...
    `}};O.styles=[J];z([g()],O.prototype,"target",void 0);O=z([E("w3m-swap-input-skeleton")],O);const Y=C`
  :host > wui-flex {
    display: flex;
    flex-direction: row;
    justify-content: space-between;
...
`;var y=function(c,t,e,o){var s=arguments.length,i=s<3?t:o===null?o=Object.getOwnPropertyDescriptor(t,e):o,r;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(c,t,e,o);else for(var l=c.length-1;l>=0;l--)(r=c[l])&&(i=(s<3?r(i):s>3?r(t,e,i):r(t,e))||i);return s>3&&i&&Object.defineProperty(t,e,i),i};const Z=5e-5;let b=class extends U{constructor(){super(...arguments),this.focused=!1,this.price=0,this.target="sourceToken",this.onSetAmount=null,this.onSetMaxValue=null}render(){const t=this.marketValue||"0",e=D.bigNumber(t).gt("0");return u`
...
//# sourceMappingURL=swaps-UEiSL6Iw.js.map
