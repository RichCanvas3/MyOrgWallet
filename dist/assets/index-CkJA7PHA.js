import{a as N,d as k,x as a,r as L,F as v,$ as p,J as O,R as Y,a0 as V,O as z,D as E,W as F}from"./index-ClMh-aiL.js";import{n as l,c as _,o as j,r as b}from"./if-defined-kl2en81P.js";import{T as A,D as W}from"./index-jweomaz_.js";import"./index-ClzcmMrP.js";import"./index-DFAWYpxS.js";import"./index-lyxmWRMW.js";var R;(function(s){s.approve="approved",s.bought="bought",s.borrow="borrowed",s.burn="burnt",s.cancel="canceled",s.claim="claimed",s.deploy="deployed",s.deposit="deposited",s.execute="executed",s.mint="minted",s.receive="received",s.repay="repaid",s.send="sent",s.sell="sold",s.stake="staked",s.trade="swapped",s.unstake="unstaked",s.withdraw="withdrawn"})(R||(R={}));const U=N`
  :host > wui-flex {
    display: flex;
