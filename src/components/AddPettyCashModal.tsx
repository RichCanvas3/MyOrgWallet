...
const AddPettyCashModal: React.FC<AddPettyCashModalProps> = ({ isVisible, onClose }) => {
  ...
  const handleSave = async () => {
    ...
    */
    ...
    if (walletSigner && walletClient && chain && privateIssuerAccount && orgDid && mascaApi && privateIssuerDid) {
        ...
        if (fullVc && indivAccountClient && burnerAccountClient && orgIssuerDelegation && orgIndivDelegation && orgAccountClient) {
