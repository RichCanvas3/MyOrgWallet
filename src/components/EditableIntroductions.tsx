...
interface EditableIntroductionsProps {
  initialValue: string;
  placeholder: string;
  className?: string;
...
const EditableIntroductions = forwardRef(({
                                           initialValue,
                                           placeholder,
                                           className = '',
                                           onChange,
                                         }: EditableIntroductionsProps, ref) => {
  ...
  return (
      ...
      ></textarea>
        ...
        {isModalOpen && (
            ...
            <textarea
                ref={textarea2Ref}
                id="introductions-fullscreen"
                name="introductions-fullscreen"
...
export default EditableIntroductions;
