...
export const UserProvider = ({children}: UserProviderProps) => {
  const [userSettings, setUserSettings] = useState<UserSettings>(() => {
    ...
    const systemInstructions = localStorage.getItem('defaultInstructions') || defaultUserSettings.systemInstructions;
    const assistantIntroductions = localStorage.getItem('defaultIntroductions') || defaultUserSettings.assistantIntroductions;
  ...
  useEffect(() => {
    if (userSettings.systemInstructions === '') {
      localStorage.removeItem('defaultInstructions');
    } else {
      localStorage.setItem('defaultInstructions', userSettings.systemInstructions);
    }
  }, [userSettings.systemInstructions]);

  useEffect(() => {
    if (userSettings.assistantIntroductions === '') {
      localStorage.removeItem('defaultIntroductions');
    } else {
      localStorage.setItem('defaultIntroductions', userSettings.assistantIntroductions);
    }
